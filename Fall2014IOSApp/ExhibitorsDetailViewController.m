...
- (void)viewDidLoad
{
    ...
    NSString * myURL = [NSString stringWithFormat:@"http://s23.a2zinc.net/clients/BICSI/canada2017/Public/eBooth.aspx?IndexInList=2&FromPage=Exhibitors.aspx&ParentBoothID=&ListByBooth=true&BoothID=%@&Nav=False", myExhibitors.boothId];
...
- (IBAction)buttonPressed:(id)sender {
    ...
    NSString * myURL = [NSString stringWithFormat:@"http://s23.a2zinc.net/clients/BICSI/canada2017/Public/eBooth.aspx?IndexInList=6&FromPage=Exhibitors.aspx&ParentBoothID=&ListByBooth=true&BoothID=%@&Nav=False", myExhibitors.boothId];
    NSURL *URL = [NSURL URLWithString:myURL];
