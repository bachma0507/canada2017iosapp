...
@synthesize userTextField = _userTextField, passwordTextField = _passwordTextField, smLoginButton, createUserButton;
...
//    [backendless.userService
//     easyLoginWithFacebookFieldsMapping:@{@"email":@"email"} permissions:@[@"email"]
...
-(void)smLogin{
    ...
    FBLoginAppViewController *fbl = [storyboard instantiateViewControllerWithIdentifier:@"FBLogin" ];
    
    [self presentViewController:fbl animated:YES completion:NULL];
}

- (IBAction)smButtonTouched:(id)sender {
